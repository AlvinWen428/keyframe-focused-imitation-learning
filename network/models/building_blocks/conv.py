...
class Conv(nn.Module):
    ...
    def __init__(self, params=None, module_name='Default'):
        ...
        if 'avepool' in params:
            if params['avepool'] is not None:
                assert isinstance(params['avepool'], (int, list, tuple)), \
                    "The output_ssize of average pooling must be int, list or tuple"
                self.layers.append(nn.AdaptiveAvgPool2d(params['avepool']))
