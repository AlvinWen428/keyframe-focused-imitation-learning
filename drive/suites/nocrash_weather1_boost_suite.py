...
class NocrashWeather1Boost(ExperimentSuite):

    def __init__(self):
        super(NocrashWeather1Boost, self).__init__('Town01')
    ...
    def build_experiments(self):
        ...
        vehicles_tasks = [20, 100]
        pedestrians_tasks = [50, 250]

        task_names = ['normal', 'cluttered']
