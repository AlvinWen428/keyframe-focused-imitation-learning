...
class NocrashWeather1DenseRep3DiffseedBoost(ExperimentSuite):

    def __init__(self):
        super(NocrashWeather1DenseRep3DiffseedBoost, self).__init__('Town01')
    ...
    def build_experiments(self):
        ...
        vehicles_tasks = [100, 100, 100]
        pedestrians_tasks = [250, 250, 250]
        vehicle_seeds = [0, 1, 2]
        pedestrian_seeds = [0, 1, 2]

        task_names = ['dense_task1', 'dense_task2', 'dense_task3']
        ...
        for weather in self.weathers:
            ...
            for iteration in range(len(poses_tasks)):
                ...
                vehicle_seed = vehicle_seeds[iteration]
                pedestrian_seed = pedestrian_seeds[iteration]
                ...
                conditions.set(
                    ...
                    WeatherId=weather,
                    SeedVehicles=vehicle_seed,
                    SeedPedestrians=pedestrian_seed
                )
