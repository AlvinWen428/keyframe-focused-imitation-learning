...
class CorlTrainingSmallRep3(ExperimentSuite):

    def __init__(self):
        super(CorlTrainingSmallRep3, self).__init__('Town01')
    ...
    def build_experiments(self):
        ...
        vehicles_tasks = [20, 20, 20]
        # pedestrians_tasks = [0, 0, 0, 50]
        pedestrians_tasks = [50, 50, 50]

        # task_names = ['straight', 'one_curve', 'navigation', 'navigation_dyn']
        task_names = ['navigation_dyn1', 'navigation_dyn2', 'navigation_dyn3', 'navigation_dyn4']
